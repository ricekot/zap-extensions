...
public class OptionsKeyboardShortcutPanel extends AbstractParamPanel {
    ...
    private KeyboardShortcuts extension;
    ...
    public OptionsKeyboardShortcutPanel(KeyboardShortcuts extension) {
        super();
    ...
    public void initParam(Object obj) {
        reset = false;
        this.setShortcuts(extension.getShortcutRows(false));
            ...
            resetButton.addActionListener(
                    new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            setShortcuts(extension.getShortcutRows(true));
                            reset = true;
                        }
                    });
        }
    ...
    public void saveParam(Object obj) throws Exception {
        extension.saveShortcuts(getShortcutModel().getElements(), reset);
        reset = false;
    }
    ...
    public String getHelpIndex() {
        return "commonlib.keyboard.options";
    }
