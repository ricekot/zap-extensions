...
public class CallbackService extends OastService
    ...
    private final Map<String, org.zaproxy.addon.oast.services.callback.CallbackImplementor>
    ...
    public CallbackService(ExtensionOast extensionOast) {
    ...
    public void registerCallbackImplementor(
            org.zaproxy.addon.oast.services.callback.CallbackImplementor impl) {
    ...
    private org.zaproxy.addon.oast.services.callback.CallbackParam getCallbackParam() {
    ...
    private class CallbackProxyListener implements OverrideMessageProxyListener {
        ...
        public boolean onHttpRequestSend(HttpMessage msg) {
            try {
                ...
                for (Entry<String, org.zaproxy.addon.oast.services.callback.CallbackImplementor>
                        callback : callbacks.entrySet()) {
