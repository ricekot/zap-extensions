...
public class CallbackOptionsPanelCard extends OastOptionsPanelCard {
    ...
    public CallbackOptionsPanelCard(CallbackService callbackService) {
    ...
    private JCheckBox getRandomPort() {
        if (randomPort == null) {
            ...
            randomPort.addActionListener(
                    ae -> getSpinnerPort().setEnabled(!randomPort.isSelected()));
        }
        return randomPort;
    }
